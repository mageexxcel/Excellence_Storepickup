<?php
namespace Excellence\Storepickup\Block\Adminhtml\Storebase\Edit\Tab;
...
class Main extends \Magento\Backend\Block\Widget\Form\Generic implements \Magento\Backend\Block\Widget\Tab\TabInterface
{
    ...
    protected function _prepareForm() {
        ...
        $storeStatus = array (
            ...
            array('value' =>2, 'label' => 'Open'),
            array('value' =>1, 'label' => 'Close'),
        );
        ...
        if ($this->moduleManager->isOutputEnabled('Excellence_Dealerlocator')) {
            $fieldset->addField(
                'is_approved', 'select', array(
                    'label'              => __('Approved'),
                    'title'              => __('Approved'),
                    'name'               => 'is_approved',
                    'required' => true,
                    'values'=> array('1'=>__('Approved'), '0'=>__('Not-Approved'))
                )
            );
        }
        
        $fieldset->addField(
            'is_storepickup', 'select', array(
                'label'              => __('Show in Storepickup'),
                'title'              => __('Show in Storepickup'),
                'name'               => 'is_storepickup',
                'required' => true,
